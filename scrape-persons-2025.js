// Scrapes the 'persons' field from each 2025 event detail page
...
async function main() {
  ...
  fs.writeFileSync('tmp/persons-2025-scraped.json', JSON.stringify(results, null, 2));
  console.log('Saved to tmp/persons-2025-scraped.json');
}
